...
/**
 * shadcn/ui -- radio-group (base-nova), from `npx shadcn@latest add
 * radio-group --view`. Written by hand because the CLI wanted to install an
 * npm package named `cn` for the import; JSX instead of TSX, every class is
 * upstream's.
 */
