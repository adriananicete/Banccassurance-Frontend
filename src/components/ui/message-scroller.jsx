/* eslint-disable react-refresh/only-export-components -- upstream re-exports the scroller hooks beside the components */
import {
...
/**
 * shadcn/ui -- message-scroller (base-nova), from `npx shadcn@latest add
 * message-scroller --view`. The behaviour lives in `@shadcn/react` (shadcn's
 * unstyled package); this file is the styling. Written by hand because the CLI
 * wanted to install an npm package named `cn` and overwrite button.jsx; JSX
 * instead of TSX, every class is upstream's.
 */
