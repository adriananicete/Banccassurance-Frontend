...
import { useExportReferrals, useReportSummary } from '@/features/reports/hooks'
import { REPORT_LEVELS, buildReportRows } from '@/features/reports/reportData'

/**
 * /referrals.
 *
 * For the tenant heads it is referrals by status, drilled place by place --
 * the Department Head walks PhilLife Region -> Group -> Account Officer, the
 * Sector Head walks Landbank Group -> Branch. This was the Reports page until
 * 2026-09-15, when Adrian moved it here and made Reports the export page.
 *
 * The roles that work referrals one by one will get the referral list here;
 * it is not built, so they keep the scaffold.
 */
